...
async function runMediasoupWorkers() {
	...
	config.mediasoup.webRtcServerOptions.listenInfos =
		config.mediasoup.webRtcServerOptions.listenInfos.map((info) => {
			return {
				...{ announcedIp: data.ip },
				...info,
			};
	...
	config.mediasoup.webRtcTransportOptions.listenIps =
		config.mediasoup.webRtcTransportOptions.listenIps.map((info) => {
			return {
				...{ announcedIp: data.ip },
				...info,
			};
	...
	config.mediasoup.plainTransportOptions.listenIp = {
		...{ announcedIp: data.ip },
		...config.mediasoup.plainTransportOptions.listenIp.map,
	};
